...
- Restore descartavel com 56 tabelas RLS, 140 policies, 1.163 grants e isolamento real de tenant.
...
- RTO <=24 h: PARTIAL; DB local 2.321 ms, plataforma completa nao testada.

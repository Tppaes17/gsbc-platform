...
**Confirmacao direta do owner (2026-09-18, nesta conversa):** ao ser perguntado explicitamente se esta secao refletia sua decisao real — dado que o texto acima apareceu no arquivo antes de qualquer dialogo comigo nesta sessao — o owner confirmou: "Sim, foi minha decisão, pode confirmar no ADR". A decisao de adotar o baseline diario (em vez de PITR ou da Opcao C de 30min) esta confirmada como intencional e autorizada pelo owner.
